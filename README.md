...
<p>This respository hosts the datasets, code, interactive graphs and website for my undergraduate final year project. The aim is to experiment with clustering and topological data analysis to detect hidden gene expression in three different types of datasets. For an overview of the work, refer to this respository's <a href="https://tommakesthings.github.io/Clustering-and-TDA-of-scRNA-seq-Data/">GitHub Pages site</a>, or read the <a href="https://tommakesthings.github.io/Clustering-and-TDA-of-scRNA-seq-Data/Paper/Clustering-and-TDA-of-scRNA-seq-Data.pdf">PDF report here</a>. If you'd like to experiment with the code yourself, refer to the <a href="#code">Running the Code</a>.</p>
